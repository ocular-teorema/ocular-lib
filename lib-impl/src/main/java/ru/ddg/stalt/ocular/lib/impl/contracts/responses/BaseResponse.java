...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = StorageListResponse.class, name = "storages_list_response"),
        @JsonSubTypes.Type(value = AddStorageResponse.class, name = "storages_add_response"),
